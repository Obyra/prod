...
var T = {
  es: {
    ...
    'precio.l1':'60 meses de servicio incluidos','precio.l2':'Sin restricciones de usuarios ni obras','precio.l3':'Mismas funcionalidades que mensual','precio.l4':'Soporte preferencial','precio.l5':'Pago seguro por transferencia',
    'precio.cta_mensual':'EMPEZAR PRUEBA GRATIS','precio.cta_licencia':'SOLICITAR POR WHATSAPP','precio.ahorro':'Ahorrás 34% vs mensual',
  ...
  en: {
    ...
    'precio.l1':'60 months of service included','precio.l2':'No user or project restrictions','precio.l3':'Same features as monthly plan','precio.l4':'Priority support','precio.l5':'Secure bank transfer payment',
    'precio.cta_mensual':'START FREE TRIAL','precio.cta_licencia':'REQUEST VIA WHATSAPP','precio.ahorro':'Save 34% vs monthly',
  ...
  de: {
    ...
    'precio.l1':'60 Monate Service inklusive','precio.l2':'Keine Benutzer- oder Projektbeschränkungen','precio.l3':'Gleiche Funktionen wie beim Monatsabo','precio.l4':'Bevorzugter Support','precio.l5':'Sichere Banküberweisung',
    'precio.cta_mensual':'KOSTENLOS TESTEN','precio.cta_licencia':'PER WHATSAPP ANFRAGEN','precio.ahorro':'34% Ersparnis gegenüber monatlich',
